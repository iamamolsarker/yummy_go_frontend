    ...
    <div className="flex items-center justify-center min-h-screen bg-[#fdfdfd] px-4">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-[10px] p-8 border border-[#3636361a]">
        ...
        <div className="flex justify-between items-center mb-8">
          <div
            className={`flex-1 h-2 rounded-full mr-2 ${step >= 1 ? "bg-[#EF451C]" : "bg-[#e5e7eb]"
              }`}
          ></div>
          <div
            className={`flex-1 h-2 rounded-full mr-2 ${step >= 2 ? "bg-[#EF451C]" : "bg-[#e5e7eb]"
              }`}
          ></div>
          <div
            className={`flex-1 h-2 rounded-full ${step >= 3 ? "bg-[#EF451C]" : "bg-[#e5e7eb]"
              }`}
          ></div>
        </div>
          ...
          <>
            ...
            <div className="mt-6 text-center">
              ...
              <p className="mt-6 text-center text-[16px] text-[#7c848a]">
                ...
                <a href="/foodman-login" className="text-[#EF451C] font-medium hover:underline">
                  Login here
                </a>
              </p>
            </div>
